# Separating Pension Costs - Calculating the Fiscal Gap {#sec-all-code}

This website uses the expenditure categories from previous Annual Reports. Pensions are removed from individual agencies and displayed as its own expenditure category. 
